...
if $(xrandr | grep -q "^eDP1 connected") && $(xrandr | grep -q "^DP1 connected .*1440x900"); then
  xrandr --output DP1 --primary --mode 1440x900 --pos 0x0 --rotate normal --output eDP1 --mode 1920x1080 --pos 1440x0 --rotate normal
